...
function drawPlayer(){
  ...
  const drawW=118, drawH=138;
  const dx=player.x-31, dy=player.y-61;
...
function drawEnemy(e){
  if(e.type==='ref'){
    if(drawArt('bobby',e.x-32,e.y-60,112,128)) return;
  }else if(e.type==='bruiser'){
    if(drawArt('brute',e.x-34,e.y-58,132,132)) return;
  }else{
    if(drawArt('mutant',e.x-28,e.y-54,112,118)) return;
  }
...
function drawPickup(p){
  ...
  ctx.shadowBlur=18;
  if(!drawArt('skullJuice',p.x-18,y-20,66,76)){
